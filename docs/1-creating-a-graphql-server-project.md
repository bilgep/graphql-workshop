...
> For mutations we are using the [relay mutation pattern](https://relay.dev/docs/v1.6.2/graphql-server-specification/#mutations) which is commonly used in GraphQL.
